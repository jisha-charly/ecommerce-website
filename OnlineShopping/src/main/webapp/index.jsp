...
<%@ page import="com.online.connection.*"%>
        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="images/ba1.webp" alt="" /></li>
                    <li><img class="img-responsive" src="images/ba1.webp" alt="" /></li>
                    <li><img class="img-responsive" src="images/ba1.webp" alt="" /></li>
                </ul>
            <!--     <div class="script-wrap">
                    <ul class="script-group">
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/baa1.jpg" alt="" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/baa2.jpg" alt="" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/baa3.jpg" alt="" />
                            </div></li>
                    </ul>
